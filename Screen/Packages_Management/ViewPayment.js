                ...
                <ScrollView>
                    ...
                    {packages.map((pkg) => (
                        ...
                        >
                            ...
                            <Text style={styles.packagePrice}> Package Total Price : Rs. {pkg.packagePrice}</Text>
                            <Text style={styles.packagePrice} > Amount Currently Paid : Rs. {pkg.paymentAmount}</Text>
                            <Text style={styles.packagePrice}> Paid Date : {pkg.paymentDate}</Text>
                            <Text style={styles.packagePrice}> Payment Status : {pkg.paymentStatus}</Text>
          ...
          <Text style={styles.packagePrice}> {selectedPackage?.packagePrice}</Text> */}
            ...
            /> */}
                        ...
                        >
                            ...
                            <Picker.Item label="Not Yet" value="Not Yet" />
                        </Picker>
                        {/* <TextInput
              // label="Package Price"
              value={paymentStatus}
